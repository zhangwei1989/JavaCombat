...
import org.combat.rest.util.PathUtils;
...
public class DefaultUriBuilder extends UriBuilder {
    ...
    public DefaultUriBuilder(DefaultUriBuilder other) {
        ...
        this.matrixParams = other.matrixParams;
    }
    ...
    private UriBuilder doResolveTemplates(Map<String, ?> templateValues, boolean encoded) {
    ...
    private URI doBuild(Map<String, ?> values, boolean encoded) {
